...
This description in generated by cmake-init and contains information on how
to work with the project as a developer.

## Developer mode

Build system targets that are only useful for developers of this project are
hidden if the `toyws_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `toyws_DEVELOPER_MODE` to the configure
